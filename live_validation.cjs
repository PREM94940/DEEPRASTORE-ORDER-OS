...
async function runValidation() {
  ...
  try {
    ...
    // Login as staff
    await page.goto('https://deeprastore-order-os.vercel.app/login', { waitUntil: 'networkidle2' });
    ...
    await page.goto('https://deeprastore-order-os.vercel.app/orders', { waitUntil: 'networkidle2' });
    await delay(2000);
    ...
    await page.goto('https://deeprastore-order-os.vercel.app/production', { waitUntil: 'networkidle2' });
    await delay(2000);
