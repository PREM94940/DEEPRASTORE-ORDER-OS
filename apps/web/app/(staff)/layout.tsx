      ...
      <body className="flex h-screen bg-zinc-950 text-zinc-50 overflow-hidden font-sans">
        <aside className="w-64 border-r border-zinc-800 bg-zinc-950 flex flex-col">
          ...
          <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
            <a href="/" className="flex items-center gap-3 px-3 py-2 rounded-md text-zinc-350 hover:text-zinc-100 hover:bg-zinc-900/50 transition-colors font-medium">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="7" height="7" x="3" y="3" rx="1"/><rect width="7" height="7" x="14" y="3" rx="1"/><rect width="7" height="7" x="14" y="14" rx="1"/><rect width="7" height="7" x="3" y="14" rx="1"/></svg>
              Dashboard
            </a>
            <a href="/orders" className="flex items-center gap-3 px-3 py-2 rounded-md text-zinc-350 hover:text-zinc-100 hover:bg-zinc-900/50 transition-colors font-medium">
            ...
            <a href="/production" className="flex items-center gap-3 px-3 py-2 rounded-md text-zinc-350 hover:text-zinc-100 hover:bg-zinc-900/50 transition-colors font-medium">
            ...
            <a href="/payments" className="flex items-center gap-3 px-3 py-2 rounded-md text-zinc-350 hover:text-zinc-100 hover:bg-zinc-900/50 transition-colors font-medium">
            ...
            <a href="/dispatch" className="flex items-center gap-3 px-3 py-2 rounded-md text-zinc-350 hover:text-zinc-100 hover:bg-zinc-900/50 transition-colors font-medium">
            ...
            <a href="/reports" className="flex items-center gap-3 px-3 py-2 rounded-md text-zinc-350 hover:text-zinc-100 hover:bg-zinc-900/50 transition-colors font-medium">
            ...
            <a href="/settings" className="flex items-center gap-3 px-3 py-2 rounded-md text-zinc-350 hover:text-zinc-100 hover:bg-zinc-900/50 transition-colors font-medium">
