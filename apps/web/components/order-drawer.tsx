    ...
    <>
      ...
      <div className="fixed inset-y-0 right-0 w-full sm:w-[480px] bg-zinc-950 border-l border-zinc-800 shadow-2xl z-50 transform transition-transform flex flex-col h-full font-sans text-sm text-zinc-300">
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6">
          ...
          {/* Quick Actions / Operational Control */}
          <div className="bg-zinc-900/50 rounded-lg border border-zinc-800 p-4 space-y-3">
            <div className="flex justify-between items-center">
              <span className="text-zinc-400 font-semibold text-xs uppercase tracking-wider">Current Status</span>
              <span className="font-bold text-blue-400">{currentStatus}</span>
            </div>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex gap-2">
                {nextOptions.length > 0 ? (
                  <select 
                    ...
                    value=""
                    className="flex-1 bg-zinc-950 border border-zinc-800 rounded-md py-2 px-3 text-zinc-100 outline-none focus:ring-1 focus:ring-blue-500 text-sm font-semibold"
                  >
                  ...
                  <div className="flex-1 bg-zinc-950/50 border border-zinc-800 rounded-md py-2 px-3 text-zinc-500 text-sm italic">No further transitions</div>
                )}
              ...
              <div className="flex gap-2">
                <a 
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex-1 flex items-center justify-center gap-2 py-2 rounded-md bg-[#25D366]/10 text-[#25D366] hover:bg-[#25D366]/20 transition-colors border border-[#25D366]/20 font-semibold text-sm"
                >
